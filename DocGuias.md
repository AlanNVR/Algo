...
Periodo academico 2026–2027 PPA
Cuarto nivel – paralelos A y B
...
Paquete de Anexos y Guias – Aprobacion Etica PFC
...
Parte I – Plantillas de los 9 documentos del Anexo A que requieren elaboracion. Los
...
Parte II – Plantillas de los documentos adicionales por categoria de riesgo etico. Com-
...
Parte III – Guia especifica de elaboracion por proyecto PFC. Para cada uno de los once
...
• Escalas: Likert de 5 puntos (1 = totalmente en desacuerdo, 5 = totalmente de acuerdo) o de
...
Estimado(a) participante: este cuestionario forma parte del proyecto “[titulo del PFC]” de-
...
2. Definir (20 min). Formulacion de la declaracion de punto de vista (POV): “[usuario] necesita
...
“Si” o “No” en cada item; toda respuesta “Si” debe explicarse en el recuadro final.
...
1. CITI Program (Collaborative Institutional Training Initiative). Modulo “Human Subjects Re-
search – Social & Behavioral Investigators” o “Responsible Conduct of Research (RCR)”.
...
Categoria A – Datos sensibles de salud o biometricos (MediCita, Gimnasio, Terapia
...
Redactar en el protocolo de investigacion una seccion titulada “Cumplimiento de la Ley
Organica de Proteccion de Datos Personales” que:

• Reconozca que los datos de salud son categoria especial de datos sensibles segun la

LOPDP.

• Cite los articulos de la LOPDP que regulan el tratamiento de datos sensibles y sus

condiciones excepcionales.

• Declare que el proyecto se acoge a la excepcion de investigacion cientifica con datos

disociados.

• Establezca al docente responsable como Delegado de Proteccion de Datos (DPO) in-

formal del proyecto.

• Detalle los derechos ARCO (Acceso, Rectificacion, Cancelacion, Oposicion) que el sis-
...
• Uso de imagenes sinteticas o de bancos publicos de datos con licencia (ej. NIH ChestX-

ray14, Kaggle synthetic datasets).

• Procedimiento de enmascaramiento automatico de rostros (blur, mosaico) si por error entra

una imagen real.

• Almacenamiento cifrado y separado del resto de datos operativos.

• Compromiso de no entrenar modelos de IA con imagenes de personas reales sin autoriza-

cion adicional.

Categoria B – Datos personales (MundiPets, RutaExpress, Marketplace UTEQ, Clinica
...
• Los puntos de origen y destino se generalizan a nivel de barrio o parroquia, no de direccion

exacta.

• Las trayectorias almacenadas se anonimizan antes del analisis (sin ID de conductor asoci-

ado).

• No se activa geolocalizacion en tiempo real durante el desarrollo; se usan datos historicos
...
• Si un menor aparece en un caso hipotetico, se requiere consentimiento del representante

legal previo cualquier interaccion.

• El sistema, en su version productiva, incluira un mecanismo de verificacion de mayoria de

edad al registrar propietarios.

• Los datos de menores, de existir en el extracto disociado facilitado por la organizacion, se

filtran y se eliminan antes del analisis.

Categoria C – Riesgo minimo operativo (AquaGest, SIMPA, Gestion Agricola
...
• Nombre de la organizacion. Sustituido por seudonimo tipo “Camaronera X” o “Palmicultora
...
• Nombres de directivos y empleados. Se reemplazan por identificadores tipo ENTR-01.
...
• AquaGest. Codigo Organico Ambiental, Ley Organica para el Desarrollo de la Acuicultura
...
• SIMPA. Regulaciones de la Agencia de Regulacion y Control Fito y Zoosanitario (AGROCAL-
...
C1 – Aval de la unidad productiva (camaronera).

C2 – Compromiso de confidencialidad sobre informacion estrategica.

C3 – Protocolo de anonimizacion de datos empresariales.

C4 – Referencia a normativa sectorial (MPCEIP, IPIAP).
...
• Manejo de historia clinica animal (no humana, pero sensible desde la perspectiva del propi-
...
B1 – Aval de la clinica veterinaria y/o convocatoria a duenos voluntarios.

B2 – Protocolo de proteccion de datos personales de duenos.

B3 – Compromiso de no uso de datos reales de historias clinicas.

B5 – Politica de manejo de datos de menores.
...
• Divulgacion de la incidencia de plagas (informacion sensible para la aseguradora y para el
...
C1 – Aval de la unidad productiva (predio palmicultor).

C2 – Compromiso de confidencialidad sobre informacion estrategica.

C3 – Protocolo de anonimizacion.

C4 – Referencia a normativa sectorial (AGROCALIDAD, MAG, ANCUPA).
...
B1 – Aval de la empresa de mensajeria.

B2 – Protocolo de proteccion de datos personales.

B3 – Compromiso de no uso de datos reales de transacciones.
...
• Posibilidad de que el personal medico mencione casos de pacientes durante la entrevista
...
A1 – Protocolo de disociacion completa desde el diseno (Privacy-by-
Design).

A2 – Declaracion de uso exclusivo de datos sinteticos.

A3 – Aval especifico del establecimiento medico.

A4 – Referencia a LOPDP articulos sobre datos sensibles.

A5 – Protocolo de manejo de imagenes clinicas (si aplica).
...
B1 – Aval institucional UTEQ (Vicerrectorado).

B2 – Protocolo de proteccion de datos personales de la comunidad.

B3 – Compromiso de no uso de datos reales de pagos.
...
• Datos de peso, medidas corporales, IMC pueden generar impacto psicologico si son mal
...
A1 – Protocolo de disociacion completa desde el diseno.

A2 – Declaracion de uso exclusivo de datos sinteticos.

A3 – Aval especifico del establecimiento deportivo.
...
A4 – Referencia a LOPDP articulos sobre datos sensibles biometricos.

Obligatorio

A5 – Protocolo de manejo de imagenes corporales (si aplica).
...
• Historia clinica animal, aunque no de humanos, contiene datos sensibles del propietario por
...
B1 – Aval de la clinica veterinaria.

B2 – Protocolo de proteccion de datos personales de propietarios.

B3 – Compromiso de no uso de datos reales.
...
FCC o directamente al Vicerrectorado Academico – la misma autoridad que aprueba la
solicitud etica – lo cual debe manejarse explicitamente para evitar apariencia de conflicto
...
• Datos personales de la comunidad UTEQ (nombres, correos institucionales, horarios de
...
• Sensibilidad de patrones de asistencia docente que pudieran revelarse por analitica de ocu-

pacion.

• Posible correlacion no autorizada con datos del SGA (calificaciones, matriculacion).

• Posible presencia de estudiantes de 17 anos en primer nivel (aunque el proyecto se focaliza
...
debe elevarse a Categoria A y elaborar adicionalmente los documentos A1–A5: (1) re-
...
B1 – Aval institucional emitido por el Decano de la FCC o el Vicerrectorado
Academico.
...
B2 – Protocolo de proteccion de datos personales de la comunidad uni-
versitaria.

Obligatorio

B3 – Compromiso de no correlacion con datos del SGA institucional.

Obligatorio

B5 – Politica de manejo de datos de menores (por precaucion, aunque no
...
PFC #10 – Sistema Inteligente de Control y Seguimiento de Terapia Fisica Categoria A – Datos
...
• Riesgo biometrico por el componente de vision por computadora: puntos anatomicos, es-

queleto, medidas corporales.

• Riesgo de dano fisico si el sistema emite retroalimentacion erronea que induzca al paciente
...
• Posibilidad de que el fisioterapeuta mencione casos de pacientes durante la entrevista (debe
...
A2 – Declaracion de uso exclusivo de datos sinteticos y bancos publicos
con licencia.

Obligatorio

A3 – Aval especifico del centro de fisioterapia.

A4 – Referencia a LOPDP articulos sobre datos sensibles de salud y bio-
metricos.
...
A5 – Protocolo de manejo de video corporal + tarjeta de modelo de IA.

Obligatorio

PFC #11 – Sistema de Gestion Agricola (cultivo de verde y cacao) Categoria C – Riesgo minimo
...
• Divulgacion de rendimiento por hectarea, precios de venta al acopiador o al exportador, y

margenes.

• Divulgacion de la incidencia de plagas y enfermedades (informacion sensible para la asegu-
...
• Datos personales del personal de campo, muchos de ellos jornaleros con vinculo laboral

informal (proteccion adicional necesaria).

• Posibilidad de que se detecten practicas no conformes con normativa laboral o ambiental
...
C1 – Aval de la unidad productiva (finca agricola).

C2 – Compromiso de confidencialidad sobre informacion estrategica y de
personal.
...
C3 – Protocolo de anonimizacion (finca, ubicacion, rendimientos, personal).

Aplica

C4 – Referencia a normativa sectorial (AGROCALIDAD, MAG, ANECACAO,
AEBE).
