...
| --- | --- | ------------------- | --- | --- | --- | ------------------------------ | --- | --- | --- | --- |
Quevedo–LosRios–Ecuador

| UTEQ|FCC|ISR-401 |              |     |              |     |         | PaquetedeAnexosyGuias–AprobacionEticaPFC |
| ---------------- | ------------ | --- | ------------ | --- | ------- | ---------------------------------------- |
...
| ------- | --------------------- | --- | --- | --------- | --- | --- | --- | --- | --- | --- |
A.2.1–Guiadeentrevistasemi-estructurada
| Datos de | la sesion |     |     |     |     |     |     |     |     |     |
| -------- | --------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
A.2.2–Cuestionariodeencuesta
Instructivo
| • Extension | maxima: | 20 items. |     |     |     |
| ----------- | ------- | --------- | --- | --- | --- |
• Escalas: Likertde5puntos(1=totalmenteendesacuerdo,5=totalmentedeacuerdo)ode
...
dente.
A4. ReferenciaaLOPDP–articulossobredatossensibles
...
|     | formal | del proyecto. |     |     |     |     |     |     |     |     |
| --- | ------ | ------------- | --- | --- | --- | --- | --- | --- | --- | --- |
• DetallelosderechosARCO(Acceso,Rectificacion,Cancelacion,Oposicion)queelsis-
...
• Nombredelaorganizacion. Sustituidoporseudonimotipo“CamaroneraX”o“Palmicultora
Y”.
...
• SIMPA.RegulacionesdelaAgenciadeRegulacionyControlFitoyZoosanitario(AGROCAL-
...
la cabecera.
| PFC#1–AquaGest |     |     |     |     | CategoriaC–Riesgominimooperativo |     |     |
| -------------- | --- | --- | --- | --- | -------------------------------- | --- | --- |
...
PFC#2–MundiPets CategoriaB–Datospersonales
...
| ----------- | ---- | -------- | --------- | --- | ----- | ----------- | -------------------------------- | ------ |
| PFC#3–SIMPA |      |          |           |     |       |             | CategoriaC–Riesgominimooperativo |        |
...
PFC#4–RutaExpress CategoriaB–Datospersonales
...
| PFC#5–MediCita |     |     |     |     |     |     |     | CategoriaA–Datossensiblesdesalud |     |
| -------------- | --- | --- | --- | --- | --- | --- | --- | -------------------------------- | --- |
...
| --------- | --- | ------------- | --- | --- | ---------- | --- | --- | --- | --- | --- | --- |
Documentos A.1 al A.12 del Anexo A (comunes obligatorios). 12 items
A1 – Protocolo de disociacion completa desde el diseno (Privacy-by- Obligatorio
Design).
...
A5 – Protocolo de manejo de imagenes clinicas (si aplica). Segun
sistema
| PFC#6–MarketplaceUTEQ |     |     |     |     |     |     |     |     | CategoriaB–Datospersonales |     |     |
| --------------------- | --- | --- | --- | --- | --- | --- | --- | --- | -------------------------- | --- | --- |
...
| --- | --- | ------------ | --- | ----- | ------ | ----- | ---------------- | ------ |
PFC#7–Sistemadegestiondegimnasio CategoriaA–Datossensiblesbiometricos
...
A5 – Protocolo de manejo de imagenes corporales (si aplica). Segun
sistema
PFC#8–Sistemadegestiondeclinicaveterinaria CategoriaB–Datospersonales
...
| --- | --- | ------------ | --- | ------ | ------ | -------- | ----------- | --- | ------ |
|     | B5  | – Politica   | de  | manejo | de     | datos    | de menores. |     | Aplica |
PFC#9–SIGA–SistemaInteligentedeGestiondeAulas CategoriaB–Datospersonales
(potencialA)
...
• Posiblepresenciadeestudiantesde17anosenprimernivel(aunqueelproyectosefocaliza
en cuarto/quinto).
...
| ---------------- | --- | --- | --- | --- | ---------------------------------------- |
Documentos A.1 al A.12 del Anexo A (comunes obligatorios). 12 items
B1–AvalinstitucionalemitidoporelDecanodelaFCCoelVicerrectorado Obligatorio
Academico.
B2 – Protocolo de proteccion de datos personales de la comunidad uni- Obligatorio
versitaria.
B3 – Compromiso de no correlacion con datos del SGA institucional. Obligatorio
B5–Politicademanejodedatosdemenores(porprecaucion,aunqueno Aplica
...
PFC#10–SistemaInteligentedeControlySeguimientodeTerapiaFisica CategoriaA–Datos
...
| --------- | ------ | -------------- | ----------- | --- | --- |
| Riesgos   | eticos | particulares   |             |     |     |
• Riesgoaltodeexposicionadatosclinicossensibles(historiaclinica,diagnostico,evolucion).
...
• Posibilidaddequeelfisioterapeutamencionecasosdepacientesdurantelaentrevista(debe
...
A1 – Protocolo de disociacion completa desde el diseno (Privacy-by- Obligatorio
Design).
A2 – Declaracion de uso exclusivo de datos sinteticos y bancos publicos Obligatorio
|     | con | licencia. |            |     |            |                  |             |
| --- | --- | --------- | ---------- | --- | ---------- | ---------------- | ----------- |
|     | A3  | – Aval    | especifico |     | del centro | de fisioterapia. | Obligatorio |
A4 – Referencia a LOPDP articulos sobre datos sensibles de salud y bio- Obligatorio
metricos.
A5 – Protocolo de manejo de video corporal + tarjeta de modelo de IA. Obligatorio
PFC#11–SistemadeGestionAgricola(cultivodeverdeycacao) CategoriaC–Riesgominimo
operativo
...
margenes.
• Divulgaciondelaincidenciadeplagasyenfermedades(informacionsensibleparalaasegu-
...
| --- | --- | ------ | ----- | ------ | ---------- | ----------------- | ------ |
C2 – Compromiso de confidencialidad sobre informacion estrategica y de Aplica
personal.
C3–Protocolodeanonimizacion(finca,ubicacion,rendimientos,personal). Aplica
C4–Referenciaanormativasectorial(AGROCALIDAD,MAG,ANECACAO, Aplica
AEBE).
...
A)
| 10  | Sistema |     | Inteligente | de  | Terapia |     |     | A   |     | 12  | 5 (A1–A5) |
| --- | ------- | --- | ----------- | --- | ------- | --- | --- | --- | --- | --- | --------- |
Fisica
| 11  | Sistema |     | de Gestion | Agricola |     |     |     | C   |     | 12  | 4 (C1–C4) |
| --- | ------- | --- | ---------- | -------- | --- | --- | --- | --- | --- | --- | --------- |
verde/cacao
